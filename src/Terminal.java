...
public class Terminal {
	...
	private static final String[] code = new String[] {
			...
			"Comm. of the ACM,1968","(Dijkstra, 1968) Dijkstra, Edsger, and Einstein, Albert. \"Go To Statement"+
			" Considered Harmful.\" Comm. of the ACM (1968).\n",
					
			"direct print journal chicago:Edsger Dijkstra,Albert Einstein,Harald Lesch,Go To Statement Considered Harmful,"+
			"Comm. of the ACM,1968","(Dijkstra, 1968) Dijkstra, Edsger, Einstein, Albert, and Lesch, Harald. \"Go To Statement"+
			" Considered Harmful.\" Comm. of the ACM (1968).\n",
	...
	public static String readLine() {
		...
		if (count > 1) {
			...
			if(code[count-1].startsWith("Error")) {
				...
				for(String datum : data) {
					...
					usedOutput = usedOutput.replaceAll(datum, "");
				}
		...
		if(count>code.length-1) {
			System.out.println("Correct Anwers: " + rightAnswers + " Wrong Anwers: " + wrongAnswers + " Time: " + (System.currentTimeMillis()-time));
		}
		return code[count - 2];
	}
